...
function catMatch(k,c){if(k==='all')return true;var fc=(c||'').toLowerCase();if(k==='large')return fc.indexOf('large')!==-1;if(k==='mid')return fc.indexOf('mid')!==-1||fc.indexOf('flexi')!==-1||fc.indexOf('focused')!==-1||fc.indexOf('multi')!==-1||fc.indexOf('contra')!==-1||fc.indexOf('value')!==-1;if(k==='small')return fc.indexOf('small')!==-1;if(k==='index')return fc.indexOf('index')!==-1||fc.indexOf('etf')!==-1;if(k==='tax')return fc.indexOf('elss')!==-1||fc.indexOf('tax')!==-1;if(k==='money')return fc.indexOf('money')!==-1||fc.indexOf('liquid')!==-1||fc.indexOf('overnight')!==-1;return true;}
