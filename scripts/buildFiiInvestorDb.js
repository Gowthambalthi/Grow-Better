...
const seedInv = [
  ...
  ["Rajat Sharma (India TV)","SPECIALIST",2800,15],
  ["Anil Singhvi (Zee Business)","SPECIALIST",1500,12],
  ["Vishal Wadhwa (CNBC)","SPECIALIST",1200,10],
  ["Parag Parikh (PPFAS)","SPECIALIST",8500,8],
  ["Ravi Dharamshi (ValueQuest)","SPECIALIST",3200,18],
  ["Rahul Shah (Motilal Oswal)","SPECIALIST",2500,14],
  ["Aashish Patheria (Phillip Capital)","SPECIALIST",1800,11],
  ["Gaurav Mallik (Phillip Capital)","SPECIALIST",1600,9],
  ["Sanjay Chawla (AIF)","SPECIALIST",2200,16],
  ["Vivek Chaand Sehgal (Motherson)","SPECIALIST",4500,7],
  ["Sundaram Mutual","SPECIALIST",12000,45],
  ["DSP Mutual Fund","SPECIALIST",15000,52],
  ["HDFC Mutual Fund","SPECIALIST",18000,68],
  ["ICICI Prudential MF","SPECIALIST",16500,55],
  ["SBI MF","SPECIALIST",14000,48],
  ["Nippon India MF","SPECIALIST",11000,42],
  ["Axis MF","SPECIALIST",9500,38],
  ["Kotak MF","SPECIALIST",8800,35],
  ["Aditya Birla Sun Life MF","SPECIALIST",8200,32],
  ["UTI MF","SPECIALIST",7500,30],
  ["Canara Robeco MF","SPECIALIST",4800,22],
  ["Mirae Asset MF","SPECIALIST",5200,25],
  ["Bandhan MF","SPECIALIST",4500,20],
  ["Invesco MF","SPECIALIST",3200,15],
  ["Taurus MF","SPECIALIST",2800,12],
  ["Quant MF","SPECIALIST",6500,28],
  ["PPFAS MF","SPECIALIST",3800,18],
  ["PGIM India MF","SPECIALIST",2500,10],
  ["Edelweiss MF","SPECIALIST",3500,14],
  ["Franklin Templeton India MF","SPECIALIST",7200,30],
  ["IDFC MF","SPECIALIST",2800,12],
  ["IIFL MF","SPECIALIST",2200,9],
  ["JM Financial MF","SPECIALIST",1800,8],
  ["L&T MF","SPECIALIST",4200,16],
  ["Mahindra Manulife MF","SPECIALIST",1500,7],
  ["Motilal Oswal MF","SPECIALIST",5800,22],
  ["Motilal Oswal (Individual)","SPECIALIST",6500,20],
  ["Navalgundkar (Leader TRF)","SPECIALIST",800,6],
  ["Vijay Chandok (ICICI)","SPECIALIST",1200,5],
];
const seedH = {
