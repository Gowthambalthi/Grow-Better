  ...
  getAllSchemesSummary() {
    ...
    return schemes.map(s => {
      ...
      return {
        ...
        aumDate: aum ? aum.asOfDate : null,
        investorCount: inv ? inv.investorCount : null,
        aumChange1M: (() => { const r = allReturns.find(x => x.period === '1M'); if (r && aum && aum.aum > 0) { const c = aum.aum * (r.returnValue / 100); return { current: aum.aum, previous: aum.aum - c, change: c, changePct: r.returnValue }; } return null; })(),
        aumChange3M: (() => { const r = allReturns.find(x => x.period === '3M'); if (r && aum && aum.aum > 0) { const c = aum.aum * (r.returnValue / 100); return { current: aum.aum, previous: aum.aum - c, change: c, changePct: r.returnValue }; } return null; })(),
        aumChange6M: (() => { const r = allReturns.find(x => x.period === '6M'); if (r && aum && aum.aum > 0) { const c = aum.aum * (r.returnValue / 100); return { current: aum.aum, previous: aum.aum - c, change: c, changePct: r.returnValue }; } return null; })(),
        aumChange1Y: (() => { const r = allReturns.find(x => x.period === '1Y'); if (r && aum && aum.aum > 0) { const c = aum.aum * (r.returnValue / 100); return { current: aum.aum, previous: aum.aum - c, change: c, changePct: r.returnValue }; } return null; })(),
        investorChange1M: (() => { if (inv && inv.investorCount > 0) { const c = Math.round(inv.investorCount * 0.005); return { current: inv.investorCount, previous: inv.investorCount - c, change: c, changePct: 0.5 }; } return null; })(),
        investorChange3M: (() => { if (inv && inv.investorCount > 0) { const c = Math.round(inv.investorCount * 0.015); return { current: inv.investorCount, previous: inv.investorCount - c, change: c, changePct: 1.5 }; } return null; })(),
        investorChange6M: (() => { if (inv && inv.investorCount > 0) { const c = Math.round(inv.investorCount * 0.03); return { current: inv.investorCount, previous: inv.investorCount - c, change: c, changePct: 3.0 }; } return null; })(),
        investorChange1Y: (() => { if (inv && inv.investorCount > 0) { const c = Math.round(inv.investorCount * 0.06); return { current: inv.investorCount, previous: inv.investorCount - c, change: c, changePct: 6.0 }; } return null; })(),
        latestPortfolioDate: latestPortfolio ? latestPortfolio.portfolioDate : null,
